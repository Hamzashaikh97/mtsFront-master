...
import {MemberDataService} from './concentrationMarginData.service';
...
export class ConcentrationmarginfinancierreportComponent {
  ...
  ConcentrationMarginData$!: Observable<ConcentrationMarginData[]>;
  ...
  constructor(public service: MemberDataService) { 
    this.ConcentrationMarginData$ = service.ConcentrationMarginData$;
